# Código de Conduta - Dynamics Talks
...
Este conteúdo foi elaborado com base no Código de Conduta da comunidade **.NET São Paulo**. Para saber mais a respeito acesse: https://github.com/DotNetSP/Codigo-de-Conduta/blob/main/README.md

Deixamos aqui nosso agradecimento ao **Renato Groffe** e à **comunidade .NET São Paulo** pela autorização em utilizarmos este **Código de Conduta**. 
